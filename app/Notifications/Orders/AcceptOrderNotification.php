...
class AcceptOrderNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    public $booking;
    public $via;
    ...
    //         'body'=> trans('dashboard.notification.order_has_been_accepted_body',['body' => auth()->user()->name ?? auth()->user()->phone],$notifiable->current_lang),
