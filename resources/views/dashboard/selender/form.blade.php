	...
	<div id="step_locales" class="content">
		...
		<div class="row">
			...
			<div class="form-group col-md-12">
				<label class="form-label" for="modern-num_of_selenders">{{ trans('dashboard.selender.num_of_selenders') }} <span class="text-danger">*</span></label>
                {!! Form::number("num_of_selenders", null, ['class' => 'form-control' , 'placeholder' => trans('dashboard.selender.num_of_selenders'),'id' => "modern-num_of_selenders"]) !!}
			</div>
