...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('dashboardAssets') }}/images/icons/logo_sm.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('dashboardAssets') }}/images/icons/logo_sm.png">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    <img src="{{ asset('dashboardAssets') }}/images/icons/logo_sm.png" alt="" style="width: 95.5px;height: 53px;padding: 1px 1px;">
                                </a>
