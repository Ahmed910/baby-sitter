	...
	<div id="step_locales" class="content">
		...
		<div class="row">
			...
			<div class="form-group col-md-6">
				...
				{!! Form::text($locale."[name]", isset($second_sub_category) ? $second_sub_category->translate($locale)->name : null, ['class' => 'form-control' , 'placeholder' => trans('dashboard.'.$locale.'.name'),'id' => "modern-{{ $locale }}"]) !!}
			</div>
			@endforeach
		</div>
    ...
    <div id="step_public_data" class="content">
        ...
        <div class="row">
			...
			<div class="form-group col-md-12">
				<label class="form-label" for="modern-price">{{ trans('dashboard.second_sub_category.price') }} <span class="text-danger">*</span></label>
				{!! Form::text("price", null, ['class' => 'form-control' , 'placeholder' => trans('dashboard.second_sub_category.price'),'id' => "modern-price"]) !!}
			</div>
        ...
        <div class="row">
	        <div class="form-group col-md-12">
	            <label class="form-label" for="modern-main_category">{{ trans('dashboard.first_sub_category.first_sub_category') }} <span class="text-danger">*</span></label>

				{!! Form::select('sub_category_id', $sub_categories, null , ['class' => 'select2 w-100' , 'placeholder' => trans('dashboard.first_sub_category.first_sub_category') , 'id' => 'modern-main_category']) !!}
	        </div>
	    </div>
